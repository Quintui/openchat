      ...
      >
        ...
        <PromptInputFooter>
          <PromptInputTools>
            ...
            <ModelSelector onOpenChange={setModelSelectorOpen} open={isModelSelectorOpen}>
              <ModelSelectorTrigger render={<PromptInputButton type="button" />}>
                  ...
                  {MODEL_GROUPS.map(
                    (chef): React.JSX.Element => (
                      <ModelSelectorGroup heading={chef} key={chef}>
                        {MODELS.filter((model: ModelOption): boolean => model.chef === chef).map(
